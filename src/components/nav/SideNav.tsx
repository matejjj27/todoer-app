  ...
  return (
    <div>
      <button
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-650 dark:focus:ring-gray-600"
      >
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-750">
          ...
          <ul className="space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Tomorrow</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">This Week</span>
              </a>
            </li>
          </ul>
